export const DEFAULT_CODENAMES_DICTIONARY = {
  id: 'default',
  name: 'Default Codenames Words',
  type: 'BUILT_IN',
  words: [
    ...
    'BERLIN', 'BERMUDA', 'BERRY', 'BILL', 'BLOCK', 'BLOW', 'BOARD', 'BOLT', 'BOMB', 'BOND',
    'BOOM', 'BOOT', 'BOTTLE', 'BOW', 'BOX', 'BRIDGE', 'BRUSH', 'BUCK', 'BUFFALO', 'BUG',
    'BUGLE', 'BUTTON', 'CALF', 'CANADA', 'CAP', 'CAPITAL', 'CAR', 'CARD', 'CARROT', 'CASINO',
    'CAST', 'CAT', 'CELL', 'CENTAUR', 'CENTER', 'CHAIR', 'CHANGE', 'CHARGE', 'CHECK', 'CHEST',
    'CHICK', 'CHINA', 'CHOCOLATE', 'CHURCH', 'CIRCLE', 'CLIFF', 'CLOAK', 'CLOCK', 'CLOUD', 'CLUB',
    'CLUE', 'COACH', 'COAL', 'COAST', 'CODE', 'COLD', 'COMIC', 'COMPOUND', 'CONCERT', 'CONDUCTOR',
