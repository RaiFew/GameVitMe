...
export function SalemPhysicalRoleSelectionScreen({ playerView, onAction, isHost }: Props) {
  ...
  const filteredRoles = availableRoles.filter((r) => r.totalSlots > 0);
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl space-y-8">
        <div className="border-b border-zinc-200 dark:border-zinc-800 pb-6 text-center sm:text-left">
          ...
          <p className="text-xs text-zinc-500 font-mono mt-1">
            Salem citizens are declaring their physical board game cards on mobile.
          </p>
        </div>
        ...
        <Card className="p-8 border border-zinc-300 dark:border-zinc-800 text-center space-y-6">
          ...
          <div className="space-y-2 max-w-md mx-auto">
            ...
            <p className="text-xs text-zinc-500 font-mono leading-relaxed">
              Salem citizen cards are strictly confidential. To prevent witch-hunting timing leaks, citizen confirmation progress is not visible.
            </p>
            <p className="text-xs text-zinc-500 font-mono">
              Once all citizens have entered their physical cards, press the button below to start the game.
            </p>
          </div>
    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl space-y-6">
      ...
      {me.roleConfirmed && (
        <Card className="p-6 border border-emerald-500/50 bg-emerald-50/30 dark:bg-emerald-950/10 text-center space-y-2">
          ...
          <p className="text-xs text-zinc-500 font-mono">
            Your card is locked in. The host will start the round once all citizens are confirmed.
          </p>
        </Card>
      )}
