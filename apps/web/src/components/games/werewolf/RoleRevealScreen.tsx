...
import { Shield, Moon, Eye, CheckCircle2, UserCheck, Lock, Users, AlertTriangle } from 'lucide-react';
...
export function RoleRevealScreen({ playerView, onAction, isHost }: Props) {
  ...
  // Player Secret Card Reveal View
  const isWolf = me.team === 'WEREWOLF' || me.roleId === 'werewolf';
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-lg space-y-6">
      ...
      >
        ...
        {/* Teammates section if werewolf */}
        {isWolf && me.teammates && me.teammates.length > 0 && (
